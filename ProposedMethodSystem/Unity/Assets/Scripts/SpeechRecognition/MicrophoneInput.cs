...
namespace SpeechRecognition
{
    public class MicrophoneInput : MonoBehaviour
    {
        ...
        private const float VADTimeout = 0.3f; // 1 second timeout for VAD
        
        private const float VoiceThreshold = 0.1f;
        private const float VoiceStartThreshold = 0.02f;
        private const float VoiceEndThreshold = 0.05f;
        ...
        public void StartRecording()
        {
            ...
            microphoneClip = Microphone.Start(null, true, 20, 16000);
            lastVoiceDetectedTime = Time.time;
        }
